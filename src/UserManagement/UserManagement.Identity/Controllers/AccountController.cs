...
using UserManagement.Identity.Services;
using UserManagement.Identity.ViewModels.Account;

namespace UserManagement.Identity.Controllers;
...
public class AccountController : Controller
{
    ...
    private readonly UserManagementContext _applicationDbContext;
    ...
    public AccountController(
        ...
        UserManagementContext applicationDbContext)
    {
